...
ARM64_PREBUILT=$NDK/toolchains/aarch64-linux-android-4.9/prebuilt/$HOST_OS-$HOST_ARCH

X86_PLATFORM=$NDK/platforms/android-9/arch-x86/
X86_PREBUILT=$NDK/toolchains/x86-4.9/prebuilt/$HOST_OS-$HOST_ARCH

X86_64_PLATFORM=$NDK/platforms/android-21/arch-x86_64/
X86_64_PREBUILT=$NDK/toolchains/x86_64-4.9/prebuilt/$HOST_OS-$HOST_ARCH

MIPS_PLATFORM=$NDK/platforms/android-9/arch-mips/
MIPS_PREBUILT=$NDK/toolchains/mipsel-linux-android-4.9/prebuilt/$HOST_OS-$HOST_ARCH
